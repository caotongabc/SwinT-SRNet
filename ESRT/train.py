...
parser.add_argument("--root", type=str, default="/data0/ct/dataset",
                    help='dataset directory')
...
def forward_chop(model, x, scale, shave=10, min_size=60000):
    ...
    if w_size * h_size < min_size:
        ...
        sr_list = [
            forward_chop(model, patch, shave=shave, min_size=min_size,scale=args.scale) \
...
def valid(scale):
    ...
    # print("dfesd"(testing_data_loader))
